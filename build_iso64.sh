...
# 3. Copy kernel
cp target/x86_64-oxideos/debug/$KERNEL_NAME $BUILD_DIR/boot/kernel.elf
...
echo "Run with: qemu-system-x86_64 -cdrom $ISO_NAME"
qemu-system-x86_64 -cdrom OxideOS.iso -serial stdio
